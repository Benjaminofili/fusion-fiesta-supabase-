  ...
  Future<void> _resendCode() async {
    ...
    try {
      final response = await Supabase.instance.client.functions.invoke(
        'verify-email',
        body: {'email': widget.email, 'resend': true},
      );
      if (response.status == 200) {
        ...
        setState(() {
          _isResending = false;
          _errorMessage = response.data['error'] ?? 'Failed to resend code';
        });
      }
    } catch (e) {
      setState(() {
  ...
  Future<void> _verifyCode() async {
    ...
    try {
      ...
      if (response.status == 200 && response.data['success']) {
        ...
        setState(() {
          _isVerifying = false;
          _errorMessage = response.data['error'] ?? 'Invalid verification code';
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                ).animate().fade(duration: 500.ms).slideY(begin: 0.2, end: 0, duration: 500.ms),
                SizedBox(height: size.height * 0.02),
                Text(
                  _isVerified
                ...
                ).animate().fade(duration: 500.ms, delay: 200.ms).slideY(begin: 0.2, end: 0, duration: 500.ms),
                if (!_isVerified) ...[
                  ...
                  ).animate().fade(duration: 500.ms, delay: 600.ms).slideY(begin: 0.2, end: 0, duration: 500.ms),
                  ...
                  ).animate().fade(duration: 500.ms, delay: 800.ms).slideY(begin: 0.2, end: 0, duration: 500.ms),
                  SizedBox(height: size.height * 0.03),
                  Row(
  ...
  Widget _buildOtpTextField(int index) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: isFocused ? theme.colorScheme.primary.withOpacity(0.1) : theme.colorScheme.surfaceContainerHighest.withOpacity(0.5),
